...
export default function OutputGrid({ selectedPlatforms, outputs, loadingStates, errors, onRetry, onPublish }) {
...
const styles = {
  ...
  title: { margin: '0 0 24px 0', fontSize: '1.5rem', fontWeight: '700', color: 'var(--text-main)' },
